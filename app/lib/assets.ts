export type AssetDefinition = {
  ...
  priceSuffix?: string;
  digits?: number;
  /** TradingView logo slug (issuer mark for funds, crypto/<id> for coins); drawn as a circular mark. */
  logo?: string;
};
...
export const assetCatalog: AssetDefinition[] = [
  ...
  { slug: "bitcoin", symbol: "BTC-USD", name: "Bitcoin", category: "Crypto", pricePrefix: "$", digits: 0, logo: "crypto/XTVCBTC" },
  { slug: "ethereum", symbol: "ETH-USD", name: "Ethereum", category: "Crypto", pricePrefix: "$", digits: 0, logo: "crypto/XTVCETH" },
  { slug: "solana", symbol: "SOL-USD", name: "Solana", category: "Crypto", pricePrefix: "$", logo: "crypto/XTVCSOL" },
  { slug: "xrp", symbol: "XRP-USD", name: "XRP", category: "Crypto", pricePrefix: "$", digits: 4, logo: "crypto/XTVCXRP" },
  ...
  { slug: "spy", symbol: "SPY", name: "SPDR S&P 500 ETF", category: "ETF", pricePrefix: "$", logo: "spdr-sandp500-etf-tr" },
  { slug: "qqq", symbol: "QQQ", name: "Invesco QQQ Trust", category: "ETF", pricePrefix: "$", logo: "invesco" },
  { slug: "iwm", symbol: "IWM", name: "iShares Russell 2000 ETF", category: "ETF", pricePrefix: "$", logo: "ishares" },
  { slug: "dia", symbol: "DIA", name: "SPDR Dow Jones Industrial Average ETF", category: "ETF", pricePrefix: "$", logo: "spdr-sandp500-etf-tr" },
  { slug: "rsp", symbol: "RSP", name: "Invesco S&P 500 Equal Weight ETF", category: "ETF", pricePrefix: "$", logo: "invesco" },
  { slug: "tlt", symbol: "TLT", name: "iShares 20+ Year Treasury Bond ETF", category: "ETF", pricePrefix: "$", logo: "ishares" },
  { slug: "gld", symbol: "GLD", name: "SPDR Gold Shares", category: "ETF", pricePrefix: "$", logo: "spdr-sandp500-etf-tr" },
  { slug: "slv", symbol: "SLV", name: "iShares Silver Trust", category: "ETF", pricePrefix: "$", logo: "ishares" },
  { slug: "smh", symbol: "SMH", name: "VanEck Semiconductor ETF", category: "ETF", pricePrefix: "$", logo: "vaneck" },
  { slug: "eem", symbol: "EEM", name: "iShares MSCI Emerging Markets ETF", category: "ETF", pricePrefix: "$", logo: "ishares" },
  { slug: "efa", symbol: "EFA", name: "iShares MSCI EAFE ETF", category: "ETF", pricePrefix: "$", logo: "ishares" },
  { slug: "arkk", symbol: "ARKK", name: "ARK Innovation ETF", category: "ETF", pricePrefix: "$", logo: "ark-invest" },
  { slug: "xlk", symbol: "XLK", name: "Technology", category: "Sector ETF", pricePrefix: "$", logo: "spdr-sandp500-etf-tr" },
  { slug: "xlf", symbol: "XLF", name: "Financials", category: "Sector ETF", pricePrefix: "$", logo: "spdr-sandp500-etf-tr" },
  { slug: "xle", symbol: "XLE", name: "Energy", category: "Sector ETF", pricePrefix: "$", logo: "spdr-sandp500-etf-tr" },
  { slug: "xlv", symbol: "XLV", name: "Healthcare", category: "Sector ETF", pricePrefix: "$", logo: "spdr-sandp500-etf-tr" },
  { slug: "xli", symbol: "XLI", name: "Industrials", category: "Sector ETF", pricePrefix: "$", logo: "spdr-sandp500-etf-tr" },
  { slug: "xly", symbol: "XLY", name: "Consumer Discretionary", category: "Sector ETF", pricePrefix: "$", logo: "spdr-sandp500-etf-tr" },
  { slug: "xlp", symbol: "XLP", name: "Consumer Staples", category: "Sector ETF", pricePrefix: "$", logo: "spdr-sandp500-etf-tr" },
  { slug: "xlre", symbol: "XLRE", name: "Real Estate", category: "Sector ETF", pricePrefix: "$", logo: "spdr-sandp500-etf-tr" },
  { slug: "xlu", symbol: "XLU", name: "Utilities", category: "Sector ETF", pricePrefix: "$", logo: "spdr-sandp500-etf-tr" },
  { slug: "xlb", symbol: "XLB", name: "Materials", category: "Sector ETF", pricePrefix: "$", logo: "spdr-sandp500-etf-tr" },
  { slug: "xlc", symbol: "XLC", name: "Communication Services", category: "Sector ETF", pricePrefix: "$", logo: "spdr-sandp500-etf-tr" },
  { slug: "hyg", symbol: "HYG", name: "iShares High Yield Corporate Bond ETF", category: "Credit", pricePrefix: "$", logo: "ishares" },
  { slug: "lqd", symbol: "LQD", name: "iShares Investment Grade Corporate Bond ETF", category: "Credit", pricePrefix: "$", logo: "ishares" },
  { slug: "tip", symbol: "TIP", name: "iShares TIPS Bond ETF", category: "Rates", pricePrefix: "$", logo: "ishares" },
];
