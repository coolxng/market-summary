  ...
  <xsl:template match="/rss/channel">
    ...
    <html lang="en">
      <head>
        ...
        <style>
          :root { --paper: #f3f0e7; --ink: #151512; --ink-soft: #515048; --line: #c9c3b5; --panel: #ebe7dc; --accent: #ff5c35; color-scheme: light dark; }
          ...
          * { box-sizing: border-box; }
          ...
          h1 { margin: 12px 0 0; font-family: Georgia, "Times New Roman", serif; font-size: clamp(38px, 8vw, 60px); font-weight: 500; letter-spacing: -.04em; line-height: 1; }
          .lede { margin: 18px 0 0; color: var(--ink-soft); font-family: Georgia, "Times New Roman", serif; font-size: 18px; line-height: 1.55; }
          ...
          li h2 { margin: 8px 0 0; font-family: Georgia, "Times New Roman", serif; font-size: 23px; font-weight: 500; letter-spacing: -.02em; line-height: 1.2; }
